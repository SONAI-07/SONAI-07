...
I engineer resilient backend systems, optimize API gateways, and design scalable AI infrastructure. My focus is on end-to-end ownership—from database schema design and distributed caching to containerized deployment and LLM orchestration. 

### Core Stack
* **Languages & Frameworks:** Java, Spring Boot, Python, FastAPI
* **Databases & Caching:** PostgreSQL, Redis (Geohashing, Distributed Locking)
* **Infrastructure & AI:** Docker, Git, GCP Pub/Sub, LangGraph, LLM Inference Optimization
